...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_MEETINGDETAILSREQUEST']._serialized_end = 295
    _globals['_MEETINGDETAILSRESPONSE']._serialized_start = 297
    _globals['_MEETINGDETAILSRESPONSE']._serialized_end = 357
    _globals['_PARTICIPANT']._serialized_start = 359
    _globals['_PARTICIPANT']._serialized_end = 386
    _globals['_LEAVEMEETINGREQUEST']._serialized_start = 388
    _globals['_LEAVEMEETINGREQUEST']._serialized_end = 425
    _globals['_LEAVEMEETINGRESPONSE']._serialized_start = 428
    _globals['_LEAVEMEETINGRESPONSE']._serialized_end = 556
    _globals['_LEAVEMEETINGRESPONSE_STATE']._serialized_start = 513
    _globals['_LEAVEMEETINGRESPONSE_STATE']._serialized_end = 556
    _globals['_BOTSERVICE']._serialized_start = 559
    _globals['_BOTSERVICE']._serialized_end = 762